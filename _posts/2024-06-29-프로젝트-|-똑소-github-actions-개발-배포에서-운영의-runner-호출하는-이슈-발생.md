...
layout: post
date: 2024-06-29
title: "[프로젝트 | 똑소] github actions 개발 배포에서 운영의 runner 호출하는 이슈 발생"
tags: [github-action, ]
categories: [시리즈, 프로젝트, ]
---
...
![0](/assets/img/2024-06-29-프로젝트-|-똑소-github-actions-개발-배포에서-운영의-runner-호출하는-이슈-발생.md/0.png)
...
- 개발 서버에서 쉘로 들어가서 self host runner가 생성한 로그 파일 리스트 확인
	...
	![5](/assets/img/2024-06-29-프로젝트-|-똑소-github-actions-개발-배포에서-운영의-runner-호출하는-이슈-발생.md/5.png)
...
![6](/assets/img/2024-06-29-프로젝트-|-똑소-github-actions-개발-배포에서-운영의-runner-호출하는-이슈-발생.md/6.png)
...
![7](/assets/img/2024-06-29-프로젝트-|-똑소-github-actions-개발-배포에서-운영의-runner-호출하는-이슈-발생.md/7.png)
...
![8](/assets/img/2024-06-29-프로젝트-|-똑소-github-actions-개발-배포에서-운영의-runner-호출하는-이슈-발생.md/8.png)
