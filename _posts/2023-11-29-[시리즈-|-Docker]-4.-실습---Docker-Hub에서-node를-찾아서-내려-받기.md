...
![0](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/0.png)
...
![1](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/1.png)
...
![2](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/2.png)
...
![3](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/3.png)
...
- 결과
	...
	![4](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/4.png)
...
- 결과
	...
	![5](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/5.png)
...
- 결과
	...
	![6](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/6.png)
...
- 결과
	...
	![7](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/7.png)
...
- 결과
	...
	![8](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/8.png)
...
- 결과
	...
	![9](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/9.png)
...
- 결과(에러): alpine의 경우 `/bin/bash`가 존재하지 않는다.
	...
	![10](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/10.png)
...
- 결과
	...
	![11](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/11.png)
...
- 결과(에러): ps가 설치되어 있지 않다.
	...
	![12](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/12.png)
...
- 결과
	...
	![13](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/13.png)
...
- 결과
	...
	![14](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/14.png)
...
- 결과
	...
	![15](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/15.png)
...
- 결과
	...
	![16](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/16.png)
...
- 결과
	...
	![17](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/17.png)
...
- 결과
	...
	![18](/assets/img/2023-11-29-[시리즈-|-Docker]-4.-실습---Docker-Hub에서-node를-찾아서-내려-받기.md/18.png)
